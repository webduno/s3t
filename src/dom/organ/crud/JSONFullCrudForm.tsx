...
const Component = forwardRef(({masterKeyName, theUrl, q__queriedObj, queriedArray, backup = [],
    ...
    async function updateData(id:any,valName:any,val="") {
        const response:any = await fetchPut(theUrl, {
    ...
    async function createCol(e:any) {
        ...
        await updateData(form.id, theSelectedItem[0][keyProperty], JSON.stringify( {...oldColVal,...{[form.colName]: form.colValue}} ))
        e.preventDefault()
    }    
