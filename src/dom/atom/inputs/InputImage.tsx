...
export const InputImage = ({
    ...
    return (<>
        ...
        {!!$theInput.current && !!firstFile && !failedUpload && (<>
            ...
            <div className={`pos-rel flex-center flex-col  bord-r-8 duno-border-fade border-lgrey   `}>
                <span className="clickble block w-100">
                    <label htmlFor="theImage" className=" block w-100" onDrop={()=>{}}>
                        <span className=" w-100 py-4 flex-col flex-center">
                            <div className='flex'>
                                <div className={"duno-circ-button-primary-desat tx-lg w-50px h-50px"}> 
                                    <BsUpload />
                                </div>
                            </div>
                            
                            <div className="duno-tx-primary py-2">
                                <span className="tx-bold-6">Click to upload</span>
                                <span className="px-1">or</span>
                                <span>drag and drop</span>
                            </div>
                            <span className="tx-bold-2 duno-tx-primary">JPG or PNG</span>
            ...
            {failedUpload && (<div className='flex-center mt-4'>
                ...
                <div>
                    ...
                    <span className='duno-tx-lightdark'>{firstFile?.name}</span>
